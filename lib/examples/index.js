...
var _defaultMapsOpts = require('../map/defaultMapsOpts');

var _defaultMapsOpts2 = _interopRequireDefault(_defaultMapsOpts);
...
var map = (0, _createMap2.default)(toMapName[getRandomIntInclusive(0, 2)], 'mapId').then(console.log);